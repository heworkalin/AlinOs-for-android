...
public abstract class TermuxSharedProperties {
    ...
    private void dumpPropertiesToLog() {
        ...
        if (props != null) Logger.logDebug(LOG_TAG, "Properties: " + props.toString());
    }

    private void dumpInternalPropertiesToLog() {
        Map<String, Object> internal = getInternalProperties();
        if (internal != null) Logger.logDebug(LOG_TAG, "Internal Properties: " + internal.toString());
    }
    ...
    public boolean isBackKeyTheEscapeKey() {
        String val = (String) getInternalPropertyValue(TermuxPropertyConstants.KEY_BACK_KEY_BEHAVIOUR, true);
        return TermuxPropertyConstants.IVALUE_BACK_KEY_BEHAVIOUR_ESCAPE.equals(val);
    }
    ...
    public boolean areVirtualVolumeKeysDisabled() {
        String val = (String) getInternalPropertyValue(TermuxPropertyConstants.KEY_VOLUME_KEYS_BEHAVIOUR, true);
        return TermuxPropertyConstants.IVALUE_VOLUME_KEY_BEHAVIOUR_VOLUME.equals(val);
    }

    public boolean shouldEnableDisableSoftKeyboardOnToggle() {
        String val = (String) getInternalPropertyValue(TermuxPropertyConstants.KEY_SOFT_KEYBOARD_TOGGLE_BEHAVIOUR, true);
        return TermuxPropertyConstants.IVALUE_SOFT_KEYBOARD_TOGGLE_BEHAVIOUR_ENABLE_DISABLE.equals(val);
    }
    ...
    public static String getNightMode(Context context) {
        Object val = getTermuxInternalPropertyValue(context, TermuxPropertyConstants.KEY_NIGHT_MODE);
        return val != null ? (String) val : TermuxPropertyConstants.DEFAULT_IVALUE_NIGHT_MODE;
    }
