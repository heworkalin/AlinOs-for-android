...
public class Am extends BaseCommand {
    ...
    */
    ...
    private PrintStream mStdout = System.out;
    private PrintStream mStderr = System.err;
    ...
    */
    ...
    public Integer onRun() throws Exception {
        ...
        if (mAm == null) {
            mStderr.println(NO_SYSTEM_ERROR_CODE);
    ...
    private int runStartService() throws Exception {
        ...
        if (mUserId == null || mUserId == USER_ALL || mUserId == USER_NULL) {
            mStderr.println("Error: Can't start service with user" +
        ...
        if (mCheckDrawOverAppsPermissions &&
            ...
            mStderr.println("Error: " + PermissionUtils.getMissingDisplayOverOtherAppsPermissionError());
            return 1;
        }
